    ...
    if let Ok(lines) = read_lines("./input.txt") {
        ...
        for line in lines {
            if let Ok(key) = line {
                ...
                if first_char == 'A'{
                    if second_char == 'X' {total_score = total_score + 4;}
                    else if second_char == 'Y' {total_score = total_score + 8;}
                    else if second_char == 'Z' {total_score = total_score + 3;}
                }
                // Paper?
                ...
                // Scissors?
                    ...
                    if second_char == 'X' {total_score = total_score + 7;}
                    else if second_char == 'Y' {total_score = total_score + 2;}
                    else if second_char == 'Z' {total_score = total_score + 6;}
                }
            }
        }
    }
